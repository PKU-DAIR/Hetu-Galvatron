...
if [[ "${MODE}" == "baseline" ]]; then
  CURVE_STORE="${CURVE_STORE:-${VARIANT_DIR}/${VARIANT}_loss_baseline.csv}"
else
  CURVE_STORE="${CURVE_STORE:-${VARIANT_DIR}/${VARIANT}_loss_test.csv}"
fi
WANDB_PROJECT="${WANDB_PROJECT:-galvatron}"
WANDB_ENTITY="${WANDB_ENTITY:-}"
WANDB_RUN_NAME="${WANDB_RUN_NAME:-${VARIANT}_${MODE}_${RUN_TAG}}"
