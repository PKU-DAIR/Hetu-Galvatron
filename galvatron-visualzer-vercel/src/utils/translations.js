...
const translations = {
  ...
  // Time visualization translations
  timeVisualizationTitle: {
    [LANGUAGES.ZH]: '训练时间分析',
    [LANGUAGES.EN]: 'Training Time Analysis'
  },
  computationTime: {
    [LANGUAGES.ZH]: '计算时间',
    [LANGUAGES.EN]: 'Computation Time'
  },
  forwardTime: {
    [LANGUAGES.ZH]: '前向传播时间',
    [LANGUAGES.EN]: 'Forward Propagation Time'
  },
  backwardTime: {
    [LANGUAGES.ZH]: '反向传播时间',
    [LANGUAGES.EN]: 'Backward Propagation Time'
  },
  communicationTime: {
    [LANGUAGES.ZH]: '通信时间',
    [LANGUAGES.EN]: 'Communication Time'
  },
  dpCommTime: {
    [LANGUAGES.ZH]: '数据并行通信时间',
    [LANGUAGES.EN]: 'Data Parallel Communication Time'
  },
  tpCommTime: {
    [LANGUAGES.ZH]: '张量并行通信时间',
    [LANGUAGES.EN]: 'Tensor Parallel Communication Time'
  },
  ppCommTime: {
    [LANGUAGES.ZH]: '流水线并行通信时间',
    [LANGUAGES.EN]: 'Pipeline Parallel Communication Time'
  },
  totalIterationTime: {
    [LANGUAGES.ZH]: '总迭代时间',
    [LANGUAGES.EN]: 'Total Iteration Time'
  },
  throughput: {
    [LANGUAGES.ZH]: '吞吐量',
    [LANGUAGES.EN]: 'Throughput'
  },
  noTimeDataAvailable: {
    [LANGUAGES.ZH]: '暂无时间分析数据，请上传配置文件并调整参数',
    [LANGUAGES.EN]: 'No time analysis data available. Please upload a config file and adjust parameters.'
  },
  efficiencyMetrics: {
    [LANGUAGES.ZH]: '效率指标',
    [LANGUAGES.EN]: 'Efficiency Metrics'
  },
  timeChartTitle: {
    [LANGUAGES.ZH]: '时间分布图表',
    [LANGUAGES.EN]: 'Time Distribution Chart'
  },
  timeDetailsTab: {
    [LANGUAGES.ZH]: '详细数据',
    [LANGUAGES.EN]: 'Detailed Data'
  },
  radarChartTab: {
    [LANGUAGES.ZH]: '雷达图',
    [LANGUAGES.EN]: 'Radar Chart'
  },
  overlapEfficiency: {
    [LANGUAGES.ZH]: '重叠效率',
    [LANGUAGES.EN]: 'Overlap Efficiency'
  },
  totalComputation: {
    [LANGUAGES.ZH]: '总计算时间',
    [LANGUAGES.EN]: 'Total Computation'
  },
  totalCommunication: {
    [LANGUAGES.ZH]: '总通信时间',
    [LANGUAGES.EN]: 'Total Communication'
  },
  
  // Device selector translations
  deviceSelector: {
    [LANGUAGES.ZH]: '设备选择',
    [LANGUAGES.EN]: 'Device Selection'
  },
  deviceType: {
    [LANGUAGES.ZH]: '设备类型',
    [LANGUAGES.EN]: 'Device Type'
  },
  deviceCount: {
    [LANGUAGES.ZH]: '设备数量',
    [LANGUAGES.EN]: 'Device Count'
  },
  deviceSingular: {
    [LANGUAGES.ZH]: '设备',
    [LANGUAGES.EN]: 'Device'
  ...
  devicePlural: {
    [LANGUAGES.ZH]: '设备',
    [LANGUAGES.EN]: 'Devices'
  },
  computationFactor: {
    [LANGUAGES.ZH]: '计算速度因子',
    [LANGUAGES.EN]: 'Computation Speed Factor'
  },
  commEfficiency: {
    [LANGUAGES.ZH]: '通信效率',
    [LANGUAGES.EN]: 'Communication Efficiency'
  },
  deviceSelectorNote: {
    [LANGUAGES.ZH]: '注意：设备类型和数量会影响计算和通信时间估计。这些值基于相对性能比较，仅供参考。',
    [LANGUAGES.EN]: 'Note: Device type and count affect computation and communication time estimates. These values are based on relative performance comparisons and are for reference only.'
  },
  rtx4090Note: {
    [LANGUAGES.ZH]: '8× RTX 4090设置是默认配置，性能因子设置为0.8（相对于A100）。',
    [LANGUAGES.EN]: '8× RTX 4090 is the default configuration with a performance factor of 0.8 relative to A100.'
  },
  useBackendCalc: {
    [LANGUAGES.ZH]: '使用后端计算',
    [LANGUAGES.EN]: 'Use Backend Calculation'
  },
  useFrontendCalc: {
    [LANGUAGES.ZH]: '使用前端计算（更快响应）',
    [LANGUAGES.EN]: 'Use Frontend Calculation (Faster Response)'
  },
};
